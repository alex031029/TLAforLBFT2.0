...
variables
    ...
    >>,
    validators2 = {"v1","v2","v3","v4"},
    sig = [v1|->1,v2|->2,v3|->3,v4|->4], 
    state = [v \in validators2 |-> 0],
    prepareSig = [v \in validators2 |->{}],
    commitSig = [v \in validators2 |->{}],
    impeachPrepareSig = [v \in validators2 |->{}],
    impeachCommitSig = [v \in validators2 |->{}],
...
\* BEGIN TRANSLATION
VARIABLES proposers, validators, validators2, sig, state, prepareSig, 
          commitSig, impeachPrepareSig, impeachCommitSig, validatorIndices, 
          pc
...
vars == << proposers, validators, validators2, sig, state, prepareSig, 
           commitSig, impeachPrepareSig, impeachCommitSig, validatorIndices, 
           pc >>
...
Lbl_1 == /\ pc = "Lbl_1"
         ...
         /\ UNCHANGED << proposers, validators2, sig, state, prepareSig, 
...
\* Last modified Tue Jul 16 18:58:34 CST 2019 by Dell
